/*
  # Franklin App Database Schema

  1. New Tables
    - `identity_areas` - Life areas for organizing actions (health, career, etc.)
    - `outcomes` - 12-week goals linked to identity areas
    - `micro_actions` - Daily actions that build towards outcomes
    - `completions` - Records of completed micro-actions with metadata
    - `reflections` - Daily reflection entries for self-assessment
  ...
  3. Security
    ...
    - Public read access for identity_areas
...
-- Create enums for Stripe integration
...
INSERT INTO identity_areas (name, description, color, sort_order) VALUES
